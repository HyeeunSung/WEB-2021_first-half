	      ...
	      <div class="container">
	        <div class="row d-flex mb-5 contact-info">
	          <div class="col-md-12 mb-4">
	            <h2 class="h4 font-weight-bold">Upload Post</h2>
	          </div>
	        </div>
	        <div class="row block-9">
	          <div class="col-md-12 order-md-last pr-md-5">
	            <form action="/linepayis/blogServlet" method="post">
	              <input type="hidden" name="key" value="write">
	              <div class="form-group">
	                <input type="text" class="form-control" name="blogTitle" placeholder="Title">
	              </div>
	              <div class="form-group">
	                <textarea cols="30" rows="7" name="blogContent" class="form-control" placeholder="Content"></textarea>
	              </div>
	              <div class="form-group">
